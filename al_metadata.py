...
ACTIVE_INPUT_SECTIONS = {
    ...
    "reweighting": (
        ...
        "reweight_lambda",
        "voronoi_l2_max_iter",
        "voronoi_l2_relative_gap_tol",
        "voronoi_l2_gradient_tol",
        "voronoi_l2_stability_window",
        "voronoi_l2_dual_relative_tol",
        "voronoi_l2_weight_l1_tol",
        "voronoi_l2_stability_patience",
        "temperature",
        "soft_topk",
        "reweight_pool_size",
        "reweight_source",
