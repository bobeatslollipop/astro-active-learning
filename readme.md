...
python3 linear_regression.py --run-name default_run --seed 42 --optimizer exact --lr 1.0 --epochs 500 --batch-size 30000 --lr-end-factor 1.0 --weight-decay 0.0 --momentum 0.0 --data-split random --low-feh-weight 5.0 --cutoff 10 --feh-threshold -2.0
```
